  ...
  return (
    <footer>
      ...
      <div className="footer-bottom">
        <p>© 2023 Astral Bridge. All rights reserved.</p>        <div className="social-links">
          ...
          <a href="https://linkedin.com/company/astralbridge" className="social-link" aria-label="Connect with us on LinkedIn">
            <svg viewBox="0 0 24 24" fill="none">
          ...
          <a href="https://github.com/astralbridge" className="social-link" aria-label="Check out our GitHub">
            <svg viewBox="0 0 24 24" fill="none">
