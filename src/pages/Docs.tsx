...
const Docs: React.FC = () => {
  const docsStructuredData = {
    ...
    "@type": "TechArticle",
    "headline": "Astral Bridge API Documentation - Cross-Chain Bridge Integration Guide",
    "description": "Complete API reference and integration guide for Astral Bridge cross-chain cryptocurrency bridging service. Learn how to integrate Solana, Ethereum, BSC bridging into your applications.",
    "author": {
      "@type": "Organization",
      "name": "Astral Bridge",
    ...
    "keywords": "API documentation, cross-chain bridge API, cryptocurrency bridge integration, blockchain API, Solana API, Ethereum API, BSC API"
  };

  return (
    <>
      <SEO 
        title="API Documentation - Astral Bridge Cross-Chain Bridge Integration Guide"
        description="Complete API reference and integration guide for Astral Bridge. Learn how to integrate cross-chain cryptocurrency bridging between Solana, Ethereum, BSC, and other blockchains into your applications."
        keywords="API documentation, cross-chain bridge API, cryptocurrency bridge integration, blockchain API, Solana API, Ethereum API, BSC API, bridge integration guide"
        canonicalUrl="https://astralbridge.org/docs"
          ...
          <section className="docs-section">
            ...
            <div className="api-info">
              <div className="api-base">
                <strong>Base URL:</strong> <code>https://api.astralbridge.org/v1</code>
              </div>
     ...
     https://api.astralbridge.org/v1/quote`}</code></pre>
            </div>
          ...
          <section className="docs-section">
            ...
            <div className="endpoint-group">
              ...
              <div className="code-block">
                <pre><code>{`curl "https://api.astralbridge.org/v1/bridge/quote?fromChain=1&toChain=56&token=0xA0b86a33E6Cc8&amount=1000000000000000000" \\
      ...
      "supportedChains": ["1", "56", "137", "42161"]
          ...
          <section className="docs-section">
            ...
            <div className="support-info">
              <ul>
                <li><strong>Email:</strong> developers@astralbridge.org</li>
